...
public class ThongKe extends javax.swing.JFrame {
    ...
    public ThongKe() {
        ...
        List list;         
        list=DbUtils.resultSetToNestedList(rs);
        ...
        this.taBaoCao.append("| Mã PM    | Mã KH    |Mã sách|   Ngày mượn  |   Hạn trả      |  Quản Thư |Ngày trả | tiền cọc| \n");
        for(int i=1;i<=list.size();i++){
            /* ResultSet row = (ResultSet)list.get(1);
            String rw = row.getString(1);*/
            this.taBaoCao.append(list.get(1).toString()+"\n");
        }
